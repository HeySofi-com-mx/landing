                            ...
                            return n()(F()(q()(b, function(b) {
                                switch (b.extractorType) {
                                    ...
                                    case "CONSTANT_VALUE":
                                        ...
                                        d = e.value;
                                        return {
                                            extractorID: b.id, jsonLD: Ca(Ba, c, d)
                                        };
                                    case "URI":
                                        ...
                                        return {
                                            extractorID: b.id, jsonLD: Ca(Ba, e, c)
                                        };
                                    default:
                            ...
                            switch (a.extractor_type) {
                                case "CSS":
                                    ...
                                    return {
                                        ...
                                        }), extractorType: "CSS", id: m()(a.id), ruleId: null === (b = a.event_rule) || void 0 === b ? void 0 : b.id
                                    };
                                case "CONSTANT_VALUE":
                                    if (null == a.extractor_config) throw new Error("extractor_config must be set");
                                    ...
                                    return {
                                        domainURI: new B(a.domain_uri), eventType: a.event_type, extractorConfig: Fa(b), extractorType: "CONSTANT_VALUE", id: m()(a.id), ruleId: null === (b = a.event_rule) || void 0 === b ? void 0 : b.id
                                    };
                                case "URI":
                                    if (null == a.extractor_config) throw new Error("extractor_config must be set");
                                    b = a.extractor_config;
                                    if (b.parameter_selectors) throw new Error("extractor_config must be set");
                                    return {
                                        domainURI: new B(a.domain_uri), eventType: a.event_type, extractorConfig: Ga(b), extractorType: "URI", id: m()(a.id), ruleId: null === (b = a.event_rule) || void 0 === b ? void 0 : b.id
                                    };
                                default:
                                    return {
                                        domainURI: new B(a.domain_uri), eventType: a.event_type, extractorType: a.extractor_type, id: m()(a.id), ruleId: null === (b = a.event_rule) || void 0 === b ? void 0 : b.id
                                    }
                            }
                        }
